...
export const darkColors: ColorTokens = {
  ...
  action: {
    primaryBg: "#2BB892",
    primaryFg: "#141816",
    primaryPressed: "#26A37E",
    primaryDisabled: "#2E3532",
    secondaryBg: "#10241D",
    secondaryFg: "#4AB99C",
    ghostFg: "#4AB99C",
    destructiveBg: "#EF4444",
    destructiveFg: "#141816"
  },
  status: {
    successFg: "#6CE9A6",
    successBg: "#0C2418",
    successBorder: "#14472C",
    warningFg: "#FDE047",
    warningBg: "#2B2109",
    warningBorder: "#4E3C0C",
    errorFg: "#FDA29B",
    errorBg: "#2C1512",
    errorBorder: "#57241F",
    infoFg: "#7CD4FD",
...
export const typography = {
  'display_xl': {
    fontFamily: Platform.select({ ios: 'IBMPlexSansThaiLooped', android: 'IBMPlexSansThaiLooped-Bold', default: 'IBMPlexSansThaiLooped' }),
    fontWeight: '900',
    fontSize: 64,
    lineHeight: 67,
    letterSpacing: -1,
  ...
  'title_sm': {
    fontFamily: Platform.select({ ios: 'IBMPlexSansThaiLooped', android: 'IBMPlexSansThaiLooped-SemiBold', default: 'IBMPlexSansThaiLooped' }),
    fontWeight: '600',
    fontSize: 20,
    lineHeight: 26,
    letterSpacing: -0.2,
  ...
  'body_lg': {
    fontFamily: Platform.select({ ios: 'IBMPlexSansThaiLooped', android: 'IBMPlexSansThaiLooped-Regular', default: 'IBMPlexSansThaiLooped' }),
    fontWeight: '400',
    fontSize: 16,
    lineHeight: 24,
    letterSpacing: 0,
...
export const elevationDark = {
  "none": Platform.select({
    ...
    // โหมดมืดยกชั้นด้วยพื้นผิว: #141816
  "xs": Platform.select({
    ios: {
      shadowColor: "transparent",
      shadowOffset: {
    ...
    // โหมดมืดยกชั้นด้วยพื้นผิว: #1F2421
  "sm": Platform.select({
    ios: {
      shadowColor: "transparent",
      shadowOffset: {
  ...
  "md": Platform.select({
    ...
    // โหมดมืดยกชั้นด้วยพื้นผิว: #262B27
  "lg": Platform.select({
    ios: {
      shadowColor: "transparent",
      shadowOffset: {
    ...
    // โหมดมืดยกชั้นด้วยพื้นผิว: #2E3532
  "xl": Platform.select({
    ios: {
      shadowColor: "#000000",
      shadowOffset: {
